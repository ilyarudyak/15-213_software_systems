...
0000000000400efc <phase_2>:
  ...
  # setup
  400efc:	55                   	push   %rbp                         ; save register %rbp
  400efd:	53                   	push   %rbx                         ; save register %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp                   ; allocate int[6] on stack

  400f02:	48 89 e6             	mov    %rsp,%rsi                    ; pass pointer to this array to read_six_numbers
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                  ; compare first element of array with 0x1
  400f0e:	74 20                	je     400f30 <phase_2+0x34>        ; if equal to 1 - go to 400f30
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>        ; if not equal to 1 - explode_bomb
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>

  ; LOOP - we get here from 400f3a and can get out only to a) explode_bomb, b) 400f3c finish
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax              ; we take previous element, double it and
  400f1a:	01 c0                	add    %eax,%eax                    ; compare with the current element
  400f1c:	39 03                	cmp    %eax,(%rbx)                  ; SOLUTION: 1 2 4 8 16 32
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx                    ; advance array pointer by 4 (int array)
  400f29:	48 39 eb             	cmp    %rbp,%rbx                    ; if out of array - go to finish
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>        ; if not equal - go to 400f17 (LOOP)
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>        ; if equal - finish phase_2
  ; end of LOOP

  ; we get here from comparison of the first element with 1
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx               ; pointer to second element of array
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp              ; pointer next to last element of array
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b>        ; jump to 400f17 (LOOP)
...
0000000000400f43 <phase_3>:
  ...
  ; call to sscanf - we read 2 int from input string to phase_3
  ; allocate space on stack for 2 int we read from input (see sscanf comments)
  400f43:	48 83 ec 18          	sub    $0x18,%rsp                 
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx             ; we call it y  
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx             ; we call it x
  ; $rsi is the 2nd arg for sscanf - pointer to format ("%d %d")
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi             
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  ; sscanf(%rdi, %rsi, %rdx, %rcx) = 
  ; sscanf(input string to phase_3, "%d %d", pointers to store these values)
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt> 
  ; sscanf have read more than 1 values (actually we have 2 ints to read)
  400f60:	83 f8 01             	cmp    $0x1,%eax                  
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>

  ; setup switch statement: we do switch on x
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)             ; we have 8 cases: 0 to 7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>      ; if x is out of this range go to default and BOOM!
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)         

  ; cases of switch statement
  ; each case put smth (call it ai, where i is case number) into %eax and jump to 0x400fbe
  ; at 0x400fbe we compare y and z, so i ai is also a solution for i = 0, 2 ... 7
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax                 ; case 0, SOLUTION 0 207
  ...
  400fad:	e8 88 04 00 00       	callq  40143a <explode_bomb>      ; default case
  400fb2:	b8 00 00 00 00       	mov    $0x0,%eax
  400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>

  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax                ; case 1, move 311 into %eax
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax             ; SOLUTION 1 311 - we compare y with 311
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>      ; if equal - finish 
  400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>      ; if not - BOOM!
...
0000000000400fce <func4>:
  ...
  ; arguments of the first call a = x, b = 0, c = 14, 
  ; b, c are independent of input to phase_4

  400fce:	48 83 ec 08          	sub    $0x8,%rsp

  ; we use new variables res (%eax), t (%ecx)
  ...
  400fe2:	39 f9                	cmp    %edi,%ecx                  ; compare x and t
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>        ; if t <= x go 400ff2

  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx            ; func4(x, b, t - 1)
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>        ; jump to finish

  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax                  ; res = 0  
  400ff7:	39 f9                	cmp    %edi,%ecx                  ; compare x and t
  400ff9:	7d 0c                	jge    401007 <func4+0x39>        ; if t >= x finish (in fact t == x)

  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi             ; set b = t + 1
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>             ; func4(x, t + 1, c)
...
000000000040100c <phase_4>:
  ...
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx              ; pointer to y 
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx              ; pointer to x 
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi              ; "%d %d"
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax                   ; sscanf should read 2 args
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)              ; x <= 14
  401033:	76 05                	jbe    40103a <phase_4+0x2e>
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>

  ; setup arguments and call func4
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx                    ; 14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                    ; 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi               ; x
  401048:	e8 81 ff ff ff       	callq  400fce <func4>               ; func4 should return 0
  40104d:	85 c0                	test   %eax,%eax                    ; == 0 only if %eax == 0
  40104f:	75 07                	jne    401058 <phase_4+0x4c>        ; if not 0 BOOM!
...
0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx                           ; save register %rbx
  401063:	48 83 ec 20          	sub    $0x20,%rsp                     ; allocate space on a stack
  401067:	48 89 fb             	mov    %rdi,%rbx                      ; save pointer to input string to phase_5 in %rbx
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)                ; save register %rax
  401078:	31 c0                	xor    %eax,%eax                      ; set %rax to 0

  ; check length of the input string
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>         ; call string_length with input string to phase_5
  40107f:	83 f8 06             	cmp    $0x6,%eax                      ; length of the string must be == 6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>          ; if OK go to main LOOP (with intermediate step)
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>          ; otherwise BOOM!
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>

  ; main LOOP - decrypt input string
  ; we loop over input string, produce new symbol and store it at location 0x10(%rsp)
  ; decryption goes as following: we clear 2nd byte of a character and use 1st byte as an offset in key string (see below)
  ; for example 'i' = 0x69, offset = 9, i -> f;
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx             ; iterate over string
  40108f:	88 0c 24             	mov    %cl,(%rsp) 
  401092:	48 8b 14 24          	mov    (%rsp),%rdx                    ; transfer the character to %rdx
  401096:	83 e2 0f             	and    $0xf,%edx                      ; erase 2nd byte ('i' -> '\t': 0x69 & 0xf = 0x9)
  ; we have a key string at this address: "maduiersnfotvbylSo you think you can stop the bomb with ctrl-c, do you?"
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)          ; we store decrypted string at location ox10(%rsp)
  4010a4:	48 83 c0 01          	add    $0x1,%rax                      ; increment %rax
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax                      ; if %rax is less than 6 - LOOP (length of our input string)
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>          ; otherwise compare decrypted string with "flyers"

  ; compare decrypted string with "flyers"
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  ; we compare our decrypted string with string at location 0x40245e
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi                 ; "flyers" - string at this location
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi                ; setup arguments for strings_not_equal
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>     ; call this function
  4010c2:	85 c0                	test   %eax,%eax                      ; strings should be equal  
  4010c4:	74 13                	je     4010d9 <phase_5+0x77>          ; go to finish if OK
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>          ; otherwise BOOM!
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>

  ; we get here in case input string length == 6, and move to the main LOOP
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax                      ; we use %rax to iterate over string, set to 0
...
00000000004010f4 <phase_6>:
  ...
  ; save registers and allocate space on stack
  ...
  ; read six numbers from input string
  ...
  ; LOOP: integers are different and <= 6
  401114:	4c 89 ed             	mov    %r13,%rbp
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax                 ; a[0] <= 5
  ...
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)           ; a[0] != a[1]
  ...
  ; main LOOP - comparison between nodes
